...
export default function HeaderConfig({
  ...
  const headerTitleElement =
    typeof headerTitle === 'function' ? headerTitle({ tintColor, children: titleText }) : null
  ...
  return (
    <ScreenStackHeaderConfig
      ...
      backgroundColor={
        headerStyleFlattened.backgroundColor ?? (headerTransparent ? 'transparent' : colors.card)
      }
